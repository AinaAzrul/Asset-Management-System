...
export class MasterDatatableComponent implements OnInit {
  ...
  updateValue(event, cell, rowIndex) {
    ...
    this.restService
      .getPosts('update_master', this.authService.getToken(), {
  ...
  deleteRow() {
    ...
    this.deleteMasterModalRef = this.modalService.open(
      DeleteMasterModalComponent
    );
    this.deleteMasterModalRef.componentInstance.row = this.selected;
    this.deleteMasterModalRef.componentInstance.valueChange.subscribe(
      (event) => {
        console.log(event);
        // this.getMaster();
        this.sendData.emit('some data...');
